...
declare function InternalList<T>({ pagination, prefixCls: customizePrefixCls, bordered, split, className, rootClassName, style, children, itemLayout, loadMore, grid, dataSource, size: customizeSize, header, footer, loading, rowKey, renderItem, locale, ...rest }: ListProps<T>, ref: React.ForwardedRef<HTMLDivElement>): React.ReactElement<any, string | React.JSXElementConstructor<any>>;
